...
WebUI.setText(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/input__username'), 'sanjayatopan23')

WebUI.setEncryptedText(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/input__password'), 'IwSHVxWMDhAtCxdZWoaRnQ==')

WebUI.click(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/button_Log in'))

WebUI.click(findTestObject('Object Repository/Page_My Account  ToolsQA Demo Site/img_Checkout_custom-logo'))
...
WebUI.selectOptionByIndex(findTestObject('Page_pink drop shoulder oversized t shirt  _e751c6/select_Choose an option363738'), 
    2)
